...
<html lang="en">
 <head>
     <title>(Tania Barron Rojas): Responsive Website</title>
  <meta charset="utf-8" />
 ...
 <body>
     <header>
     <h1>Tania Barron Rojas</h1>
        <nav class="topnav" id="myTopnav">
            <a href="index.html" class="active">Home</a>
            <a href="/web150/timeofday/" target="_blank">Time Of Day</a>
            <a href="/web150/daily/" target="_blank">Daily Grind</a>
   ...
   <main class="wrapper">
     ...
     -->  
       ...
       if(isset($_POST['Name'])){//show data
        ...
        $to  = 'Taniabarron59@gmail.com';//put your email here
